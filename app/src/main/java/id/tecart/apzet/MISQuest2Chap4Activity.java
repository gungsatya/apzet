...
public class MISQuest2Chap4Activity extends AppCompatActivity {
    String rightAnswer1;
    String rightAnswer2;
    String rightAnswer3;
    String word1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mis_quest2_chap4);
        ...
        choice1Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (countAnswer != 4){
                    Intent intent = new Intent (getApplicationContext(), MISQuest2Chap5Activity.class);
                    ...
                    intent.putExtra("rightAnswer4", rightAnswer4);
